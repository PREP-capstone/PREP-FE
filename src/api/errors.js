export const API_ERROR_CODES = {
  ...
  PROPOSAL_REPORT_PDF_REQUIRED: 'PROPOSAL_REPORT_PDF_REQUIRED',
  PROPOSAL_REPORT_TOO_LARGE: 'PROPOSAL_REPORT_TOO_LARGE',
...
export const API_ERROR_MESSAGES = {
  ...
  [API_ERROR_CODES.PROPOSAL_REPORT_PDF_REQUIRED]: 'PDF 파일만 업로드할 수 있어요.',
  [API_ERROR_CODES.PROPOSAL_REPORT_TOO_LARGE]: '파일이 너무 커요. 10MB 이하 PDF로 업로드해주세요.',
  [API_ERROR_CODES.PROPOSAL_NOT_FOUND]: '제안서를 찾을 수 없거나 만료되었어요.',
};
